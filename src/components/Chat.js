                    ...
                    <div class="col-7 left-block">
                        <section class="chat">
                            <div class="header-chat">
                                <div class="left">
                                    <img src={mainLogo} class="arrow" alt="Arrow Logo" />
                        ...
                        <i class="icon fa fa-comments clickable" style={{ fontSize: "25pt", marginLeft: "10px" }} aria-hidden="true"></i>
                            <input
                                value={this.state.inputValue}
                                onChange={evt => this.updateInputValue(evt)}
                                onKeyDown={e => {
                                    if (e.key === "Enter") {
                                        this.didSendMessage(this.state.inputValue);
